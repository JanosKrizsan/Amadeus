...
namespace Amadeus.Forms
{
    partial class Rdp
    {
        ...
        private void InitializeComponent()
        {
            ...
            rdpCredsHelpBtn = new BaseButton(_res, "rdpCredsHelpBtn", true, 16, new object[] { default, new Point(174, 458), new Padding(174, 55, 3, 3), new Size(40, 23) });
            recheckConnBtn = new BaseButton(_res, "recheckConnBtn", true, 9, new object[] { default, new Point(33, 228), default, new Size(120, 23), "Recheck Connection" });
            editCrntBtn = new BaseButton(_res, "editCrntBtn", true, 6, new object[] { default, new Point(33, 190), new Size(75, 23), "Edit" });
            delCrntBtn = new BaseButton(_res, "delCrntBtn", true, 5, new object[] { default, new Point(33, 161), new Size(75, 23), "Delete" });
            connectCrntBtn = new BaseButton(_res, "connectCrntBtn", true, 4, new object[] { default, new Point(33, 129), new Size(75, 23), "Connect To" });
            refreshRdpsBtn = new BaseButton(_res, "refreshRdpBtn", true, 3, new object[] { default, new Point(237, 57), new Size(60, 23), "Refresh" });
            saveNUpdtBtn = new BaseButton(_res, "saveNUpdtBtn", true, args: new object[] { default, new Point(19, 10), new Padding(19, 10, 3, 3), new Size(110, 23), "Save / Update" });
            saveToRdpFileBtn = new BaseButton(_res, "saveToRdpFileBtn", true, 5, new object[] { default, new Point(19, 46), new Padding(19, 10, 3, 3), new Size(110, 23), "Save as .RDP" });
            saveToXmlBtn = new BaseButton(_res, "saveToXmlBtn", true, 4, new object[] { default, new Point(19, 82), new Padding(19, 10, 3, 3), new Size(110, 23), "Save as .XML" });
            connGivenBtn = new BaseButton(_res, "connGivenBtn", true, 2, new object[] { default, new Point(19, 118), new Padding(19, 10, 3, 3), new Size(110, 23), "Quick Connect" });
            resetBtn = new BaseButton(_res, "resetBtn", true, 1, new object[] { default, new Point(19, 154), new Padding(19, 10, 3, 3), new Size(110, 23), "Reset To Defaults" });
            screenSettingsHelpBtn = new BaseButton(_res, "screenSettingsHelpBtn", true, 3, new object[] { default, new Point(88, 185), new Padding(88, 5, 3, 3), new Size(40, 23), "Help!" });
